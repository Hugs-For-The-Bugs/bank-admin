...
if($result->num_rows > 0){while($row = $result->fetch_assoc()){ $transaction++;  }}

$result = $conn->query("SELECT * FROM accounts WHERE active='0'");
if($result->num_rows > 0){while($row = $result->fetch_assoc()){ $inactive++;  }}

$result = $conn->query("SELECT * FROM accounts WHERE active='1'");
if($result->num_rows > 0){while($row = $result->fetch_assoc()){ $accounts++;  }}
...
<div class="widget__subtitle">Total Number of Activated Accounts</div>
</div>
<div class="widget__box widget__box--left">
<div class="widget__informer"><?php echo $accounts;?> Activated Account(s)</div>
</div></div>
</div></div>
...
<div class="widget__line">
<div class="widget__icon">
<span class="li-briefcase"></span></div>
<div class="widget__title">Inactive Accounts</div>
<div class="widget__subtitle">Total Number of Inactive Accounts</div>
</div>
<div class="widget__box widget__box--left">
<div class="widget__informer"><?php echo $inactive; ?> Inactive Account(s)</div>
</div></div></div></div>

<div class="col-12 col-lg-4 margin-bottom-20">
<div class="widget invert">
<div class="widget__icon_layer widget__icon_layer--right">
<span class="li-cash-dollar"></span></div><div class="widget__container">
<div class="widget__line">
<div class="widget__icon">
<span class="li-cash-dollar"></span>
</div>
<div class="widget__title">Transactions</div>
<div class="widget__subtitle">Total Number of Transactions</div>
</div>
<div class="widget__box widget__box--left">
<div class="widget__informer"><?php echo $transaction; ?> Transaction(s)</div>
</div>
</div></div></div>
</div>
<div class="row">
...
<div class="widget__title">User Management</div>
<div class="widget__subtitle">Notification from all Users</div>
</div>
...
{ 
  ...
  {  
    ...
    if ($row['active'] == 1) { $status = "Active"; } else { $status= "Inactive"; }
      ...
      echo '<td><a href="approve.php?mixhtyr12noitcudorpobguhtennek007='.$row['id'].'" class="btn btn-success btn-block" >Activate</a></td>';
      echo '<td><a href="decline.php?mixhtyr12noitcudorpobguhtennek007='.$row['id'].'" class="btn btn-danger btn-block">Deactivate</a></td></tr>';
  }
}
